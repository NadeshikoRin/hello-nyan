...
<nav>
    <div class="nav-wrapper">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            <li><a href="{{url('/BonRegist/addUser')}}">Add User</a></li>
            <li><a href="{{url('/BonRegist/updateUser')}}">Update User</a></li>
            <li><a href="{{url('/BonRegist/login')}}">Logout</a></li>
        </ul>
    </div>
</nav>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col l4 offset-l2 s12">
                ...
                <ul>
                    <li><a class="grey-text text-lighten-3" href="{{url('/BonRegist/addUser')}}">Add User</a></li>
                    <li><a class="grey-text text-lighten-3" href="{{url('/BonRegist/updateUser')}}">Update User</a></li>
